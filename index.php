<?php
    ...
    $versionQS = generateVersionQueryString($isLicensed, $isEnterpriseEdition);

    performTempThemeFix(dirname(__FILE__) ."/settings", dirname(__FILE__), dirname(__FILE__) . "/application/frontend/css");
    // move theme.css to new location in root dir. will be removed in next release
...
<head>
    <title><?php print getMonstaPageTitle($isEnterpriseEdition); ?></title>
