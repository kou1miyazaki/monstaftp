<?php
    ...
    abstract class LocalizableExceptionDefinition {
        ...
        public static $INSTALL_DIRECTORY_NOT_WRITABLE_ERROR = "INSTALL_DIRECTORY_NOT_WRITABLE_ERROR";
    ...
    $EXCEPTION_CODE_MAP = array(
        ...
        LocalizableExceptionDefinition::$INSTALL_DIRECTORY_NOT_WRITABLE_ERROR,
