<?php
    ...
    function fileGetContentsInUtf8($filePath) {
        ...
        $inputFileEncoding = @mb_detect_encoding($content, 'UTF-8, ISO-8859-1', true);

        if ($inputFileEncoding === false)
            return $content;

        return mb_convert_encoding($content, 'UTF-8', $inputFileEncoding);
    }
