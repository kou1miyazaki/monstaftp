<?php
    ...
    class ArchiveExtractor {
        ...
        private function getSessionKey() {
            return "archive_contents_" . $this->getArchivePath();
        }
        ...
        private function setupArchiveHandle() {
            ...
            if (isset($_SESSION[$this->getSessionKey()]))
                $this->flatFileList = $_SESSION[$this->getSessionKey()];
            else {
                $this->flatFileList = $this->archiveHandle->getFileNames();
                $_SESSION[$this->getSessionKey()] = $this->flatFileList;
            }
        }
        ...
        private function extractAndUploadItem($connection, $archive, $itemIndex) {
            ...
            $remoteDirectoryPath = PathOperations::remoteDirname($uploadPath);
